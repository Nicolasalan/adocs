     ...
     themeConfig: {
       ...
       sidebar: [
         ...
         },
         {
          ...
          collapsible: true,
          items: [
            { text: "ROS Basic Concepts", link: "/ros/concepts" },
            { text: "ROS Topics", link: "/ros/topics" },
            { text: "ROS Services", link: "/ros/services" },
            { text: "ROS Groups", link: "/ros/groups" },
            { text: "ROS Actions", link: "/ros/actions" },
            { text: "Debugging Tools", link: "/ros/debug" },
          ],
        },
         {
           text: "ROS",
